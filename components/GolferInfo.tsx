      ...
      {Array(numberOfGolfers).fill(1).map((_, index) => {
        return (
          ...
          <div key={index} className="mb-3">
            ...
            <input type="text" required={true} className="form-control" name={"golfer" + (index + 1) + "_name"} />
          </div>
          <div key={index} className="mb-3">
            <label className="form-label">Email</label>
            <input type="email" required={true} className="form-control" name={"golfer" + (index + 1) + "_email"} />
